...
import com.geo.GeofenceUtils.REMOVE_TYPE;
import com.geo.GeofenceUtils.REQUEST_TYPE;
...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.geofence_registration_layout);

        onRegisterClicked(getCurrentFocus());
    ...
    public void onRegisterClicked(View view) {
        ...
        /*
         * Add Geofence objects to a List.
         */

        DBHelper dbHelper = new DBHelper(MainActivity.this);
        ArrayList<ClubGeoData> geofences = dbHelper.getAllClubsGeoData();
        dbHelper.close();

        for (ClubGeoData data : geofences)
            mCurrentGeofences.add(convertClubGeoDataToGeofence(data));
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),
                    "Geofences registration successful!", Toast.LENGTH_SHORT)
                    .show();
        } catch (UnsupportedOperationException e) {
            // Notify user that previous request hasn't finished.
            Toast.makeText(this,
    ...
    private Geofence convertClubGeoDataToGeofence(ClubGeoData data) {
        return new Geofence.Builder()
                .setRequestId(data.getId())
                .setCircularRegion(data.getLatitude(), data.getLongitude(),
                        data.getRadius())
